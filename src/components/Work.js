...
function Work() {
  ...
  return (
    <div>
      {isTabletOrMobile && (
        <div className="works" style={{ width: "22rem", fontSize: "0.7rem" }}>
          {/* <h1>My latest works: </h1> */}
          <Carousel fade>
            <Carousel.Item>
              <Card style={{ width: "22rem" }} bg="dark" text="white">
                <Card.Img style={{ height: "60vh" }} variant="top" src={NFT} />
                <Card.Body class="myCardBody">
            ...
            <Carousel.Item>
              <Card style={{ width: "22rem" }} bg="dark" text="white">
                ...
                <Card.Body class="myCardBody">
                  ...
                  <Card.Text className="cardText">
                    This app provides the user with realtime btc/usd exchange
                    rates. Tech used=> React.js/redux-toolkit, websockets. I
                    initially made the app using vite instead of
                    create-react-app, and state hooks. They both work the same.
                    I'll provide the source codes.
                  </Card.Text>
                  <Button
            ...
            <Carousel.Item>
              <Card style={{ width: "22rem" }} bg="dark" text="white">
                ...
                <Card.Body class="myCardBody">
                  ...
                  <Card.Text>
                    A game done by an international group of coders that strives
                    to teach kids some basic math, animal names, and spelling.
                    In the front-end Vanilla JS is used. For the back-end, we
                    chose Google Firestore. First 5 fastest typers are shown on
                    the best scores list. The game is made for The Odin
                    Project's 1st game-jam.
                  </Card.Text>
                  <Button
      ...
      {isDesktopOrLaptop && (
        <div className="works" style={{ width: "50rem" }}>
          {/* <h1>My latest works: </h1> */}
          <Carousel fade>
            <Carousel.Item>
              <Card style={{ width: "50rem" }} bg="dark" text="white">
                <Card.Img style={{ height: "60vh" }} variant="top" src={NFT} />
                <Card.Body class="myCardBody">
                  <Card.Title>NFT collection</Card.Title>
                  <Card.Text className="cardText">
